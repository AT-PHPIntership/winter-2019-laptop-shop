                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="index4.html">User</a>
                                </li>
                                <li>
                                    <a href="index2.html">Category</a>
                                </li>
                                <li>
                                    <a href="index3.html">Product</a>
                                </li>

                                <li>
                                    <a href="index4.html">Order</a>
                                </li>
                                <li>
                                    <a href="index4.html">Order Product</a>
                                </li>
                                <li>
                                    <a href="index4.html">Promotion</a>
                                </li>
                                <li>
                                    <a href="index4.html">Product Promotion</a>
                                </li>
                                <li>
                                    <a href="index4.html">Image</a>
                                </li>
                                <li>
                                    <a href="index4.html">Comment</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="{{ route('categories.index') }}">Order Product</a>
                                </li>
                                <li>
                                    <a href="{{ route('promotions.index') }}">Promotion</a>
                                </li>
                                <li>
                                    <a href="{{ route('categories.index') }}">Product Promotion</a>
                                </li>
                                <li>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        @if($image)
                                            @foreach($image as $item)
                                                @if($item->imageable_id == Auth::id() && $item->imageable_type == 'App\User') 
                                        ...
                                        <div class="account-dropdown js-dropdown" style="display:inline">
